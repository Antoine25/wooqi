...
[pytest](http://pytest.org). It allows to code tests in a very special way. It is a useful tool to
...
For the reasons listed above, Wooqi can be considered as an independent tool instead of a simple
pytest plugin.
